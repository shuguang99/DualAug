...
import aug_lib
from Augment import autoaugment, fast_autoaugment
...
class CutoutDefault(object):
    ...
    def __call__(self, img, x=0, y=0, get_info=False , use_info=False):
...
def get_randaugment(n, m, weights, bs):
    ...
    if n == 501 and m == 501:
        return torchvision.transforms.AutoAugment(torchvision.transforms.AutoAugmentPolicy.IMAGENET)
