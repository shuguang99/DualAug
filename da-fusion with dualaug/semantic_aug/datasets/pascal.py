from semantic_aug.few_shot_dataset import FewShotDataset, DualFewShotDataset
...
PASCAL_DIR = "/home/wzh/da-fusion/data/VOCdevkit/VOC2012/"
...
class DualPASCALDataset(DualFewShotDataset):
    ...
    def __init__(self, *args, split: str = "train", seed: int = 0,
        ...
        super(DualPASCALDataset, self).__init__(
            *args, examples_per_class=examples_per_class,
            synthetic_probability=synthetic_probability,
            basic_generative_aug=basic_generative_aug,
            heavy_generative_aug=heavy_generative_aug,
