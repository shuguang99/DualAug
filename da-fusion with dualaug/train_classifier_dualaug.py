...
from semantic_aug.datasets.pascal import PASCALDataset,DualPASCALDataset
...
def run_experiment(examples_per_class: int = 0, 
    ...
    train_dataset = DATASETS[dataset](
        ...
        basic_generative_aug=basic_aug,
        heavy_generative_aug=heavy_aug,
        seed=seed,
    ...
    if num_synthetic > 0 and aug is not None:
        train_dataset.basic_generate_augmentations(model,num_synthetic)
    ...
    for epoch in trange(num_epochs, desc="Training Classifier"):
        ...
        if epoch <10:
            ...
            if epoch==10:
                if num_synthetic > 0 and aug is not None:
                    train_dataset.dual_generate_augmentations(model, num_synthetic)
